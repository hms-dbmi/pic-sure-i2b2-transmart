...
grails {
	plugin {
		springsecurity {
			...
			auth0 {
				active = false
				clientId = '__TM_CLIENT_ID__'
				clientSecret = '__TM_CLIENT_SECRET__'
				domain = '__TM_CLIENT_DOMAIN__'
				useRecaptcha = false
...
org.transmart.security.oauth.login_endpoint = '/psamaui/login?redirection_url=/transmart/login/callback_processor'
org.transmart.security.oauth.logout_endpoint = '/psamaui/logout?redirection_url=/transmart/login/callback_processor'
